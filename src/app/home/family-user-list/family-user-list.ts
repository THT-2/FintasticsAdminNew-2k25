...
export class FamilyUserList implements OnInit{
  public apiUrl = ApiRoutesConstants.BASE_URL+ ApiRoutesConstants.familyUser_list;
    ...
    this.navService.getData(this.apiUrl).subscribe({
      next:(res:any)=> {
        ...
        if (res.Code === 200) {
          ...
          this.roleData = res.Data[0].familyUser_list;
        }
        else {
