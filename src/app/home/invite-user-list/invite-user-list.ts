...
@Component({
  ...
  templateUrl: './invite-user-list.html',
  styleUrl: './invite-user-list.scss',
  providers:[AlertService]
})

export class InviteUserList implements OnInit{
  public apiUrl = ApiRoutesConstants.BASE_URL+ ApiRoutesConstants.InviteUser_list;
  ...
  constructor(private navService: Data, private router: Router,private route :ActivatedRoute,
    ...
    this.columnDefinition = HeaderConstants.InviteUserHeader;
  }
  ngOnInit(): void {
    this.getroledata();
  }
